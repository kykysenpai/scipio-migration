...
import be.mytcc.scipio.model.docker.DockerContainerVolumeRepository;
...
public class DockerController {
    ...
    public DockerContainer createSavedDockerContainer(@RequestBody DockerContainer dockerContainer){
    ...
    @PatchMapping("/saved-containers")
    public DockerContainer updateSavedContainer(@RequestBody DockerContainer dockerContainer){
        return dockerContainerRepository.save(dockerContainer);
    }
}
